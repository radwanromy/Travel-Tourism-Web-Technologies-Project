...
<link rel="stylesheet" href="../CSS/style.css" />
 <script type="text/javascript" src="../JS/cursor.js">  </script>
	<body>
			 <style>
body {
  background-image: url('../Photo/room.jpg');
...
<td colspan="2" > <section align="right">  <a href=../Home.php> <img src="../Image/logo.JPG" width="180" height="080" align ="left"/></a>
        ...
        <fieldset>
          <h3 style="color:#00ccff;font-size:40px;" align ="center">  
 Hotel System Admin Dashboard<br>🏠Add Room🏠</h3>
        ...
        <tr> <td width="250px" align="right">
             ...
             <td width="250px" style="color: #00ccff"  align="center"> 
              <select name="quality" style="color: #00ccff"   id="quality" border="0">
							<option  style="color: #00ccff" value="5 Stars">5 Stars</option>
							<option  style="color: #00ccff" value="4 Stars">4 Stars</option>
							<option  style="color: #00ccff" value="3 Stars">3 Stars</option>
							<option  style="color: #00ccff" value="2 Stars">2 Stars</option>
							<option  style="color: #00ccff" value="1 Stars">1 Stars</option>
							<option  style="color: #00ccff" value="Camping">Camping</option>
						</select><br>
            </td>
        </tr>
        <tr>
            ...
            <td align="center">
                <h3><input type="text"  style="color: #00ccff"  name="roomNo" id="roomNo" value="" placeholder="Enter The Room Number"></h3> 
            </td>
        </tr>
         <tr> <td width="250px" align="right">
                <h3>
             ...
             <td width="250px" align="center"> 
              <select name="bed"  style="color: #00ccff"  id="bed" border="0">
							...
							<option value="Double(2 single Beded Room)">Double(2 single Beded Room)</option>
							<option value="Couple(1 Big Beded Room)">Couple(1 Big Beded Room)</option>
							<option value="Family(Max 6 Person)">Family(Max 6 Person)</option>
						</select><br>
				...
				<td align="center"><?=$rooms[$i]['roomid']?></td>
					...
					<form method="GET" action="../Controller/editRoom.php">
						...
						<form  action="deleteRoom.php" method="GET">
                           <input type="text" name="roomNo" value="<?= $rooms[$i]['roomNo']?>" hidden >
